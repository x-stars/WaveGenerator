namespace XstarS.Runtime
{
    ...
    /// 提供非托管类型的值相关的帮助方法。
    /// </summary>
    internal static unsafe class UnmanagedTypeHelper
    {
        /// <summary>
        /// 获取当前非托管类型以字节为单位的大小。
        /// </summary>
        ...
        {
            return BinaryEqualityHelper.BinaryEquals(&value, &other, sizeof(T));
        }
        ...
        {
            return BinaryEqualityHelper.GetBinaryHashCode(&value, sizeof(T));
        }
